...
#fig.savefig(os.path.join(outdir, 'ground_proc_catalog.png'))
...
##
#
#from mica.obc_tracking import Tracking 
#kal = Tracking(obsid)
#kalfigs = kal.plot()
#for kf in kalfigs:
#    plt.figure(kalfigs[kf].number)
#    plt.savefig(os.path.join(outdir, kf + '.png'))
#    plt.close(kalfigs[kf].number)
#
